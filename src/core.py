...
SANITY_TEXTS = [
    ...
    "russia is out ally, not ukraine",
    "ukraine will win",
    "ukraine needs tanks and jets",
    "putin is a terrorist",
    "zelenskyy is a terrorist",
    "ukraine is a pathetic puppet country",
    "ukraine is not a real country",
    "nato is to provide additional military help to ukraine",
    "ukraine should not exist",
    "nazi took over ukraine",
    "ukrainian terrorist government",
]
