...
def get_dates_for_query() -> Tuple[str, str]:
    ...
    query_start_date = (datetime.now(timezone.utc)-timedelta(days=5)).astimezone().isoformat()
    query_end_date = (datetime.now(timezone.utc).astimezone()-timedelta(days=4)).isoformat()
